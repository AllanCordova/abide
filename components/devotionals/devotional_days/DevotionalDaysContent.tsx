      ...
      <div className="grid grid-cols-1 gap-4">
        {days.map((day, index) => (
          <Link
            ...
            key={day.id}
            className="group block" // Adicionei block para garantir estrutura
          >
            {/* Adicionei 'h-full' e flex-col para o card crescer se tiver verso */}
            <div className="flex flex-col p-4 md:p-5 bg-surface border border-border rounded-xl hover:border-primary/50 hover:bg-surface/80 transition-all duration-200 h-full">
              ...
              {/* --- AQUI ENTRA O VERSO --- */}
              {/* O React Suspense cuidará do carregamento deste pedaço */}
